...
const AGENT_INSTRUCTIONS = [
  ...
  'After synchronization: from the app repository run SYM_PROFILE_ID=<active-profile-id> node scripts/bind-profile-credential.js, then restart cosmise-streamboards with the profile-scoped run_app tool so its backend receives COSMISE_MCP_TOKEN. The helper must not print the credential.',
