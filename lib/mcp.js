...
const LOCAL_TOOLS = [
  {
    ...
    description: 'REQUIRED ENTRY POINT. Read how this backend-owned MCP wrapper uses the protected Cosmise integration, drives bounded realtime state, chooses existing layouts, creates supported metrics and formulas, and verifies the finished report.',
