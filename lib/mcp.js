...
const LOCAL_TOOLS = [
  {
    ...
    description: 'REQUIRED ENTRY POINT. Read how to connect the separate production Cosmise MCP safely, recover missing credential access, drive local realtime state, choose existing layouts, create supported metrics and formulas, and verify the finished report.',
